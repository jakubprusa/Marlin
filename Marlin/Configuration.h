...
#define STRING_CONFIG_H_AUTHOR "(Jakub, Tiskni3DDoma)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "RebeliX X2"
...
#define Z_PROBE_OFFSET_FROM_EXTRUDER -3.8   // Z offset: -below +above  [the nozzle]
